...
class _ShopScreenState extends State<ShopScreen> {
  ...
  Future<void> _buyItem(String itemCode, int price, int maxLimit) async {
    final result = await _viewModel.buyItem(itemCode, price, maxLimit);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  const Icon(Icons.local_florist, size: 16, color: sakuraPink),
                                  const SizedBox(width: 4),
                                  Text(
                                    '${_viewModel.currentExp} EXP',
                              ...
                              Stack(
                                ...
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: const Icon(Icons.pets, size: 36, color: Colors.black87),
                                  ),
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: const Icon(Icons.auto_fix_high, size: 14, color: Colors.deepPurple),
                                    ),
                                  ),
                                ],
                              ),
                        ...
                        _buildItemCard(
                          ...
                          ownedQty: _viewModel.inventory['STREAK_SHIELD'] ?? 0,
                        ),
                        ...
                        _buildItemCard(
                          ...
                          ownedQty: _viewModel.inventory['REVIVE_POTION'] ?? 0,
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _buildItemCard({
    ...
    final int currentExp = _viewModel.currentExp;
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            alignment: Alignment.center,
            child: Icon(iconData, size: 32, color: isMax ? Colors.grey : Colors.deepPurpleAccent),
          ),
          const SizedBox(width: 16),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Icon(Icons.local_florist, size: 14, color: Colors.pink),
                        const SizedBox(width: 4),
                        Text(
                          '$price EXP',
                          style: const TextStyle(
